...
Description = 'DSC module providing resources to manage Qlik Sense'
...
NestedModules = @('./DSCClassResources/WaitForQlikResource.psm1', './DSCClassResources/QlikOdag.psm1',
    './DSCClassResources/QlikProxy.psm1', './Private/Common.psm1')
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = @('Qlik', 'Sense', 'PSEdition_Desktop', 'Windows')

        # A URL to the license for this module.
        LicenseUri = 'https://github.com/ahaydon/Qlik-DSC/blob/master/LICENSE'

        # A URL to the main website for this project.
        ProjectUri = 'https://github.com/ahaydon/Qlik-DSC'
